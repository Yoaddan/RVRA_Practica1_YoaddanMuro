...
public class ElementoUIXR : MonoBehaviour
{
    ...
    private void Start()
    {
        xRCamera = CameraPointerPractica4.Instance.gameObject.GetComponent<Camera>();
    }
    ...
    {
        Vector3 screenPos = xRCamera.WorldToScreenPoint(CameraPointerPractica4.Instance.hitPoint);
